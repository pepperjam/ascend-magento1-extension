...
class Pepperjam_Network_Model_Observer
{
	...
	{
		if (!Mage::getStoreConfig('pepperjam_newtork/pepperjam_network/product_feed_enabled')) {
	...
	{
		if (!Mage::getStoreConfig('pepperjam_newtork/pepperjam_network/order_feed_enabled')) {
