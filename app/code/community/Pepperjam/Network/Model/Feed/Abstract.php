...
abstract class Pepperjam_Network_Model_Feed_Abstract
{
	 ...
	 * </code>
	 *
	 * @see src/app/code/community/EbayEnterprise/Affiliate/etc/config.xml pepperjam_newtork/pepperjam_network/feeds contains mappings used for the affiliate feeds
