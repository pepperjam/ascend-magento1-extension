...
class Pepperjam_Affiliate_Test_Model_Feed_AbstractTest extends EcomDev_PHPUnit_Test_Case
{
	/**
	...
	public function testGenerateFeed()
	{
		...
		$feed = $this->getModelMock(
			'pepperjam_affiliate/feed_abstract',
	...
	public function testApplyMapping()
	{
		...
		$mappings = array(
			'fieldA' => array(
				'class' => 'pepperjam_affiliate/map_order', 'type' => 'helper',
		...
		$this->replaceByMock('helper', 'pepperjam_affiliate/map_order', $feedHelper);

		$config = $this->getHelperMock('pepperjam_affiliate/config', array('getCallbackMappings'));
	...
	{
		$callbackConfig = array('class' => 'pepperjam_affiliate', 'type' => 'helper', 'method' => 'getSomething');
		$feed = $this->getModelMock(
			'pepperjam_affiliate/feed_abstract',
		...
		$this->setExpectedException('Pepperjam_Affiliate_Exception_Configuration');
	...
	public function provideCallbacksToValidate()
	{
		return array(
			...
			array(
				array('type' => 'disabled', 'class' => 'pepperjam_affiliate'),
				true
			),
			array(
				array('type' => 'model'),
			...
			array(
				array('type' => 'singleton', 'class' => 'pepperjam_affiliate/feed_abstract'),
				false
			),
			array(
				array('type' => 'helper', 'class' => 'pepperjam_affiliate/map', 'method' => 'getOrderId'),
				false
			),
			array(
				array('type' => 'helper', 'class' => 'pepperjam_affiliate/map', 'method' => 'getOrderId', 'column_name' => 'OID'),
				true
			),
		);
	}
