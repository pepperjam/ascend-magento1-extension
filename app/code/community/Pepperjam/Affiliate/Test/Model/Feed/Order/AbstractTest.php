...
class Pepperjam_Affiliate_Test_Model_Feed_Order_AbstractTest extends EcomDev_PHPUnit_Test_Case
{
	/**
	...
	public function testGetFileName()
	{
		...
		$feed = $this->getModelMock(
			'pepperjam_affiliate/feed_order_itemized',
		...
		$config = $this->getHelperMock('pepperjam_affiliate/config', array('getProgramId'));
