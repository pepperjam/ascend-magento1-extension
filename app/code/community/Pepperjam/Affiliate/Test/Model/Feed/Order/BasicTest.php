...
class Pepperjam_Affiliate_Test_Model_Feed_Order_BasicTest extends EcomDev_PHPUnit_Test_Case
{
	/**
	...
	{
		$config = $this->getHelperMock('pepperjam_affiliate/config', array('getBasicOrderFeedFields'));
		...
		$feed = Mage::getModel('pepperjam_affiliate/feed_order_basic');
		$this->assertSame(
			array('one', 'two', 'three'),
