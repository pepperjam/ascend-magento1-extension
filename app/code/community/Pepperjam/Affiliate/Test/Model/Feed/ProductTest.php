...
class Pepperjam_Affiliate_Test_Model_Feed_ProductTest extends EcomDev_PHPUnit_Test_Case
{
	/**
	 * Test that Pepperjam_Affiliate_Model_Feed_Product::_getItems will return
	...
	public function testGetItems()
	{
		...
		$feedProduct = Mage::getModel('pepperjam_affiliate/feed_product', array('store' => $store));
	...
	/**
	 * Test that Pepperjam_Affiliate_Model_Feed_Product::_getFeedFields will
	...
	public function testGetFeedFields()
	{
		...
		$configHelper = $this->getHelperMock('pepperjam_affiliate/config', array(
		...
		$feedProduct = Mage::getModel('pepperjam_affiliate/feed_product');
	...
	/**
	 * Test that Pepperjam_Affiliate_Model_Feed_Product::_getFileName will return
	...
	/**
	 * Test that Pepperjam_Affiliate_Model_Feed_Product::_applyMapping will
	...
	public function testApplyMapping()
	{
		...
		$feedProduct = $this->getModelMock('pepperjam_affiliate/feed_product', array('_invokeCallBack'));
