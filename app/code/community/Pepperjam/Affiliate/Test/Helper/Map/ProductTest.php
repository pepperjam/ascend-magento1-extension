...
class Pepperjam_Affiliate_Test_Helper_Map_ProductTest extends EcomDev_PHPUnit_Test_Case
{
	/**
	 * Test that Pepperjam_Affiliate_Helper_Map_Product::getCategory will
	...
	public function testGetCategory()
	{
		...
		$mapProduct = $this->getHelperMock('pepperjam_affiliate/map_product', array('_getCategoriesByIds'));
	...
	/**
	 * Test that Pepperjam_Affiliate_Helper_Map_Product::getImageUrl will
	...
	public function testGetImageUrl()
	{
		...
		$mediaUrl = 'http://www.example.com/' .
			Pepperjam_Affiliate_Helper_Map_Product::MEDIA_PATH . $image;
		...
		$helperProduct = $this->getHelperMock('pepperjam_affiliate/map_product', array(
	...
	/**
	 * Test that Pepperjam_Affiliate_Helper_Map_Product::getInStockQty will
	...
	public function testGetInStockQty()
	{
		...
		$this->assertSame($qty, Mage::helper('pepperjam_affiliate/map_product')->getInStockQty($params));
	}
	/**
	 * Test that Pepperjam_Affiliate_Helper_Map_Product::_getCategoriesByIds
	...
	public function testGetCategoriesByIds()
	{
		...
		$mapProduct = $this->getHelperMock('pepperjam_affiliate/map_product', array());
	...
	/**
	 * Test that Pepperjam_Affiliate_Helper_Map_Product::getInStockYesNo will
	...
	public function testGetInStockYesNo()
	{
		...
		$this->assertSame($result, Mage::helper('pepperjam_affiliate/map_product')->getInStockYesNo($params));
	}
}
