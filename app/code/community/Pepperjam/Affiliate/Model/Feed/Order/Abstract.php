...
abstract class Pepperjam_Affiliate_Model_Feed_Order_Abstract extends Pepperjam_Affiliate_Model_Feed_Abstract
{
	...
	protected function _getStoreIdsToInclude()
	{
		return array_map(
			...
			Mage::helper('pepperjam_affiliate')->getAllStoresForProgramId(
				Mage::helper('pepperjam_affiliate/config')->getProgramId($this->_store)
			)
		);
	}
	/**
	...
	protected function _getFileName()
	{
		return sprintf(
			...
			Mage::helper('pepperjam_affiliate/config')->getProgramId($this->getStore()),
