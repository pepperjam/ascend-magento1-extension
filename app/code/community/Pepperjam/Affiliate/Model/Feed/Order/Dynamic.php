...
class Pepperjam_Affiliate_Model_Feed_Order_Dynamic extends Pepperjam_Affiliate_Model_Feed_Order_Abstract
{
	/**
	...
	{
		return explode(',', Mage::helper('pepperjam_affiliate/config')->getDynamicOrderFeedFields());
	}
	...
	{
		return Mage::helper('pepperjam_affiliate/config')->getDynamicOrderFeedFileFormat();
	}
}
