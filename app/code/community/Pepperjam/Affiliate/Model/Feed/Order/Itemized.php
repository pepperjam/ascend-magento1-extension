...
class Pepperjam_Affiliate_Model_Feed_Order_Itemized extends Pepperjam_Affiliate_Model_Feed_Order_Abstract
{
	/**
	...
	{
		$lastRunTime = date(static::SELECT_TIME_FORMAT, Mage::helper('pepperjam_affiliate/config')->getOrderLastRunTime() ?: 0);
	...
	{
		return explode(',', Mage::helper('pepperjam_affiliate/config')->getItemizedOrderFeedFields());
	}
	/**
	...
	{
		return Mage::helper('pepperjam_affiliate/config')->getItemizedOrderFeedFileFormat();
	}
}
