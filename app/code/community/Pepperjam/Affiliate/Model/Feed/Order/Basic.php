...
class Pepperjam_Affiliate_Model_Feed_Order_Basic extends Pepperjam_Affiliate_Model_Feed_Order_Abstract
{
	/**
	...
	{
		return explode(',', Mage::helper('pepperjam_affiliate/config')->getBasicOrderFeedFields());
	}
	/**
	...
	{
		return Mage::helper('pepperjam_affiliate/config')->getBasicOrderFeedFileFormat();
	}
}
