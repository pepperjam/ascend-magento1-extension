 ...
 */
class Pepperjam_Affiliate_Helper_Map
{
	/**
	...
	{
		return Mage::helper('pepperjam_affiliate/config')->getProgramId($params['store']);
	}
	/**
	...
	public function getValueYesNo(array $params)
	{
		return sprintf(
			isset($params['format']) ? $params['format'] : '%s',
			Mage::helper('pepperjam_affiliate')->parseBoolToYesNo(
