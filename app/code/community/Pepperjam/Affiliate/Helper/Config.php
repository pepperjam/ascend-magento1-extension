 ...
 * @codeCoverageIgnore
 */
class Pepperjam_Affiliate_Helper_Config
{
	const BEACON_URL_PATH = 'pepperjam_newtork/pepperjam_affiliate/beacon_url';
	const ENABLED_PATH = 'pepperjam_newtork/pepperjam_affiliate/active';
	const ORDER_TYPE_PATH = 'pepperjam_newtork/pepperjam_affiliate/order_type';
	const PROGRAM_ID_PATH = 'pepperjam_newtork/pepperjam_affiliate/program_id';
	const TRANSACTION_TYPE_PATH = 'pepperjam_newtork/pepperjam_affiliate/transaction_type';
	const EXPORT_FILE_PATH_CONFIG_PATH = 'pepperjam_newtork/pepperjam_affiliate/export_path';
	const CALLBACK_MAPPINGS_PATH = 'pepperjam_newtork/pepperjam_affiliate/feeds/callback_mappings';
	const PRODUCT_FEED_MAPPING_PATH = 'pepperjam_newtork/pepperjam_affiliate_product_attribute_map';
	const PRODUCT_FEED_FILENAME_FORMAT_PATH = 'pepperjam_newtork/pepperjam_affiliate/feeds/product/file_name_format';
	const DYNAMIC_ORDER_FEED_MAPPING_PATH = 'pepperjam_newtork/pepperjam_affiliate/feeds/order_dynamic/fields';
	const ITEMIZED_ORDER_FEED_MAPPING_PATH = 'pepperjam_newtork/pepperjam_affiliate/feeds/order_itemized/fields';
	const BASIC_ORDER_FEED_MAPPING_PATH = 'pepperjam_newtork/pepperjam_affiliate/feeds/order_basic/fields';
	const DYNAMIC_ORDER_FEED_FILE_FORMAT_PATH = 'pepperjam_newtork/pepperjam_affiliate/feeds/order_dynamic/file_name_format';
	const ITEMIZED_ORDER_FEED_FILE_FORMAT_PATH = 'pepperjam_newtork/pepperjam_affiliate/feeds/order_itemized/file_name_format';
	const BASIC_ORDER_FEED_FILE_FORMAT_PATH = 'pepperjam_newtork/pepperjam_affiliate/feeds/order_basic/file_name_format';
	const ORDER_LAST_RUN_PATH = 'pepperjam_newtork/pepperjam_affiliate/feed/last_run_time';
	const JS_FILES = 'pepperjam_newtork/pepperjam_affiliate/js_files';
	const CONDITIONAL_PIXEL_ENABLED = 'pepperjam_newtork/pepperjam_affiliate/conditional_pixel_enabled';
	const SOURCE_KEY_NAME = 'pepperjam_newtork/pepperjam_affiliate/source_key_name';
	const PRODUCT_FEED_ENABLED = 'pepperjam_newtork/pepperjam_affiliate/product_feed_enabled';
	const ORDER_FEED_ENABLED = 'pepperjam_newtork/pepperjam_affiliate/order_feed_enabled';
