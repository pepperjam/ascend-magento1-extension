...
class Pepperjam_Affiliate_Helper_Data extends Mage_Core_Helper_Abstract
{
	...
	{
		return Mage::helper('pepperjam_affiliate/config')->getBeaconBaseUrl() . '?' .
	...
	{
		$key = Mage::helper('pepperjam_affiliate/config')->getSourceKeyName();
